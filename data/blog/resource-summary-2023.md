...
- `可选` [主要的编程范例](http%3A%2F%2Fwww.eecs.ucf.edu%2F~leavens%2FComS541Fall97%2Fhw-pages%2Fparadigms%2Fmajor.html%23imperative "http://www.eecs.ucf.edu/~leavens/ComS541Fall97/hw-pages/paradigms/major.html#imperative")
...
- `可选` [dash](https://kapeli.com/dash)
- `可选` [Worktile](https://worktile.com/) - 团队协作
- `可选` [图表秀](https://sso.tubiaoxiu.com/login?service=https://www.tubiaoxiu.com/srv/login/cas)
- `可选` [从前端开发攻城狮的角度打造更好用的 Mac OS](https://github.com/rccoder/blog/issues/22)
- `可选` [oh-my-zsh让终端好用到飞起~](https://juejin.im/post/5d773da76fb9a06aff5e9a99 "https://juejin.im/post/5d773da76fb9a06aff5e9a99")
- `可选` [简明 VIM 练级攻略](https://coolshell.cn/articles/5426.html)

## 算法

- `可选` [《算法导论》答案](https://www.kancloud.cn/windmissing/algorithms-my-answer/115225) \[电子书\]
- `可选` [目錄：演算法與資料結構](http%3A%2F%2Falrightchiu.github.io%2FSecondRound%2Fmu-lu-yan-suan-fa-yu-zi-liao-jie-gou.html "http://alrightchiu.github.io/SecondRound/mu-lu-yan-suan-fa-yu-zi-liao-jie-gou.html") \[电子书\]
- `可选` [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) \[库\]
- `可选` [CLRS](https://github.com/gzc/CLRS) \[库\]
- `可选` [MathJax与LaTex公式简介 (转载)](https://www.cnblogs.com/linxd/p/4955530.html)
- `可选` [MathJax basic tutorial and quick reference](https://math.meta.stackexchange.com/questions/5020/mathjax-basic-tutorial-and-quick-reference/5044)
- `可选` [为什么算法渐进复杂度中对数的底数总为2](http%3A%2F%2Fblog.codinglabs.org%2Farticles%2Fwhy-logarithm-base-of-asymptotic-time-complexity-always-two.html "http://blog.codinglabs.org/articles/why-logarithm-base-of-asymptotic-time-complexity-always-two.html")
...
- `推荐` [CMD 命令速查手册](https://www.jb51.net/help/cmd.htm)
- `可选` [macOS/Linux 环境变量设置](https://github.com/nodejh/nodejh.github.io/issues/34)
- `可选` [Shell脚本编程30分钟入门](https://github.com/qinjx/30min_guides/blob/master/shell.md)
- `可选` [Mac 上“磁盘工具”中可用的文件系统格式](https://support.apple.com/zh-cn/guide/disk-utility/dsku19ed921c/mac)（是否区分文件名大小写）
- `可选` [ESLint couldn&#39;t determine the plugin uniquely.](https://github.com/eslint/eslint/issues/13385)
- `可选` [编程中 #！ 这个梗是什么意思？](https://www.zhihu.com/question/333282017)
- `可选` [127.0.0.1 vs 0.0.0.0 vs localhost vs 主机IP](https://cloud.tencent.com/developer/article/1031020)
- `可选` [SCP or SFTP：用哪个？](https://www.jianshu.com/p/3adcce4e2661)
- `可选` [理解 CRLF，LF](https://www.jianshu.com/p/ec9564fe1c2b)
- `可选` [UML建模之时序图（Sequence Diagram）](https://www.cnblogs.com/ywqu/archive/2009/12/22/1629426.html)
- `可选` [程序员必备画图技能之——时序图](https://www.cnblogs.com/54chensongxia/p/13236965.html)
- `可选` [UML系列](https://www.cnblogs.com/wolf-sun/p/3430150.html)
- `可选` [Windows安装Charles并设置HTTPS代理](https://www.jianshu.com/p/d7043009e224)
...
- `推荐` [V8: 连接 Ignition 与 Turbofan](https://docs.google.com/presentation/d/1chhN90uB8yPaIhx_h2M3lPyxPgdPmkADqSNAoXYQiVE/edit) \[PPT\]
- `推荐` [Ignition: 快速启动的 V8 解释器](https://docs.google.com/presentation/d/1HgDDXBYqCJNasBKBDf9szap1j4q4wnSHhOYpaNy5mHU/edit#slide=id.g1357e6d1a4_0_58) \[PPT\]
- `推荐` [Ignition: V8 解释器](https://docs.google.com/presentation/d/1OqjVqRhtwlKeKfvMdX6HaCIu9wpZsrzqpIVIwQSuiXQ/edit#slide=id.g1357e6d1a4_0_58) \[PPT\]
- `推荐` [Firing up the Ignition interpreter](https://v8.js.cn/blog/ignition-interpreter/)
- `推荐` [Understanding V8’s Bytecode](https://medium.com/dailyjs/understanding-v8s-bytecode-317d46c94775)
- `推荐` [V8 中推测优化机制的介绍](https://ponyfoo.com/articles/an-introduction-to-speculative-optimization-in-v8)
- `推荐` [TurboFan 编译器概述](https://docs.google.com/presentation/d/1H1lLsbclvzyOF3IUR05ZUaZcqDxo7_-8f4yJoxdMooU/edit)
- `推荐` [V8 中的反优化](https://docs.google.com/presentation/d/1Z6oCocRASCfTqGq1GCo1jbULDGS-w-nzxkbVF7Up0u0)
- `推荐` [TurboFan: V8 新的代码生成架构](https://docs.google.com/presentation/d/1_eLlVzcj94_G4r9j9d_Lj5HRKFnq6jgpuPJtnmIBs88)
- `推荐` [Launching Ignition and TurboFan](https://v8.js.cn/blog/launching-ignition-and-turbofan/)（全面使用 Ignition + TurboFan 以及带来的优势说明）
- `可选` [深入研究 TurboFan JIT](https://v8.js.cn/blog/turbofan-jit/)
- `可选` [TurboFan 的故事](https://benediktmeurer.de/2017/03/01/v8-behind-the-scenes-february-edition)
- `可选` [Ignition + TurboFan 以及 ES2015](https://benediktmeurer.de/2016/11/25/v8-behind-the-scenes-november-edition)
- `可选` [TurboFan IR](https://docs.google.com/presentation/d/1Z9iIHojKDrXvZ27gRX51UxHD-bKf1QcPzSijntpMJBM)
- `可选` [TurboFan’s JIT 设计](https://docs.google.com/presentation/d/1sOEF4MlF7LeO7uq-uThJSulJlTh--wgLeaVibsbb3tc)
- `可选` [动态语言的快速算法](https://docs.google.com/a/google.com/presentation/d/1wZVIqJMODGFYggueQySdiA3tUYuHNMcyp_PndgXsO1Y)
- `可选` [代码缓存](https://v8.js.cn/blog/code-caching/)
- `可选` [关于懒惰（laziness）机制的实习经历：去优化函数的延迟取消链接](https://v8.js.cn/blog/lazy-unlinking/)
- `可选` [惰性优化的实习经历](https://docs.google.com/presentation/d/1AVu1wiz6Deyz1MDlhzOWZDRn6g_iFkcqsGce1F23i-M) \[PPT\]
- `可选` [后台编译](https://v8.js.cn/blog/background-compilation/)（多线程编译提升编译速度）
- `可选` [改进代码缓存](https://v8.js.cn/blog/improved-code-caching/)
- `可选` [JIT-less V8](https://v8.js.cn/blog/jitless/)
- `可选` [Blazingly fast parsing, part 1: optimizing the scanner](https://v8.js.cn/blog/scanner/)（扫描器性能优化）
- `可选` [Blazingly fast parsing, part 2: lazy parsing](https://v8.js.cn/blog/preparser/)（预解析性能优化）

### 垃圾回收

- `可选` [免费获取垃圾回收](https://v8.js.cn/blog/free-garbage-collection/)
- `可选` [Jank 克星第一部分](https://v8.js.cn/blog/jank-busters/)（如何提升垃圾回收机制的性能）
- `可选` [Jank 克星第二部分: Orinoco](https://v8.js.cn/blog/orinoco/)
- `可选` [Orinoco：新生代垃圾回收](https://v8.js.cn/blog/orinoco-parallel-scavenger/)
- `可选` [V8 的并发标记](https://v8.js.cn/blog/concurrent-marking/)
...
- `推荐` [给 JavaScript 开发者的代码缓存指南](https://v8.js.cn/blog/code-caching-for-devs/)
- `推荐` [The story of a V8 performance cliff in React](https://v8.js.cn/blog/react-cliff/)
- `可选` [V8 extras](https://v8.js.cn/blog/v8-extras/)（创建 V8 内置 JavaScript API）
- `可选` [优化 V8 内存消耗](https://v8.js.cn/blog/optimizing-v8-memory/)
- `可选` [How V8 measures real-world performance](https://v8.js.cn/blog/real-world-performance/)
- `可选` [Temporarily disabling escape analysis](https://v8.js.cn/blog/disabling-escape-analysis/)
- `可选` [Optimizing hash tables: hiding the hash code](https://v8.js.cn/blog/hash-code/)（哈希表中的索引存储优化）
- `可选` [Lazy deserialization](https://v8.js.cn/blog/lazy-deserialization/)（惰性内置和反序列化）
- `可选` [从 JS 追踪到 DOM 并返回](https://v8.js.cn/blog/tracing-js-dom/) （调试内存泄漏的小技巧）
- `可选` [Chrome 的一小步，V8 的一大堆](https://v8.js.cn/blog/heap-size-limit/)（内存泄漏相关）
- `可选` [High-performance ES2015 and beyond](https://v8.js.cn/blog/high-performance-es2015/#a-modern-architecture-for-a-modern-language)
- `可选` [Fast for-in in V8](https://v8.js.cn/blog/fast-for-in/)
- `可选` [Embedded builtins](https://v8.js.cn/blog/embedded-builtins/)（减少内置 API 的运行内存）
- `可选` [在 V8 中 提升 DataView 的性能](https://v8.js.cn/blog/dataview/)
- `可选` [Getting things sorted in V8](https://v8.js.cn/blog/array-sort/)（V8 中排序算法的性能优化）
- `可选` [加速 \[...spread\] 运算](https://v8.js.cn/blog/spread-elements/)
- `可选` [更快的异步函数和 Promise](https://v8.js.cn/blog/fast-async/)
- `可选` [JavaScript 的性能开销(2019版)](https://v8.js.cn/blog/cost-of-javascript-2019/)
- `可选` [更轻量的 V8](https://v8.js.cn/blog/v8-lite/)
- `可选` [V8 发布 v7.8](https://v8.js.cn/blog/v8-release-78/)
- `可选` [V8 中的指针压缩](https://v8.js.cn/blog/pointer-compression/)
- `可选` [更快的 JavaScript 调用](https://v8.js.cn/blog/adaptor-frame/)
- `可选` [超快的 super 属性访问](https://v8.js.cn/blog/fast-super/)
- `可选` [短内置调用](https://v8.js.cn/blog/short-builtin-calls/)

### WebAssembly

- `可选` [Experimental support for WebAssembly in V8](https://v8.js.cn/blog/webassembly-experimental/)
- `可选` [WebAssembly browser preview](https://v8.js.cn/blog/webassembly-browser-preview/)
- `可选` [Liftoff: a new baseline compiler for WebAssembly in V8](https://v8.js.cn/blog/liftoff/)（WebAssembly 的基线编译器 Liftoff）
- `可选` [Code caching for WebAssembly developers](https://v8.js.cn/blog/wasm-code-caching/)
- `可选` [Emscripten and the LLVM WebAssembly backend](https://v8.js.cn/blog/emscripten-llvm-wasm/)
- `可选` [Outside the web: standalone WebAssembly binaries using Emscripten](https://v8.js.cn/blog/emscripten-standalone-wasm/)
- `可选` [.wasm 是什么？wasm 反编译简介](https://v8.js.cn/blog/wasm-decompile/)
- `可选` [Up to 4GB of memory in WebAssembly](https://v8.js.cn/blog/4gb-wasm-memory/)
- `可选` [Faster JS-to-Wasm calls](https://v8.js.cn/blog/v8-release-90/#faster-js-to-wasm-calls)

### ECMAScrit 规范

- `可选` [理解 ECMAScript 规范, 第1部分](https://v8.js.cn/blog/understanding-ecmascript-part-1/)
- `可选` [Understanding the ECMAScript spec, part 2](https://v8.js.cn/blog/understanding-ecmascript-part-2/)
- `可选` [Understanding the ECMAScript spec, part 3](https://v8.js.cn/blog/understanding-ecmascript-part-3/)
- `可选` [Understanding the ECMAScript spec, part 4](https://v8.js.cn/blog/understanding-ecmascript-part-4/)

### 其他资源

- `推荐` [JavaScript engine fundamentals: Shapes and Inline Caches](https://mathiasbynens.be/notes/shapes-ics)
- `推荐` [JavaScript engine fundamentals: optimizing prototypes](https://mathiasbynens.be/notes/prototypes)
- `推荐` [浏览器是如何工作的：Chrome V8让你更懂JavaScript](https://segmentfault.com/a/1190000037435824)
- `推荐` [V8 是怎么跑起来的 —— V8 中的对象表示](https://www.cnblogs.com/chargeworld/p/12236848.html)
- `推荐` [V8 blogs](https://github.com/RogerZZZZZ/V8-blog) \[专栏\]
- `可选` [V8 at the BlinkOn 6 conference](https://v8.js.cn/blog/blinkon-6/)
- `可选` [Google 漫画](https://www.google.com/googlebooks/chrome/big_00.html)
- `可选` [Celebrating 10 years of V8](https://v8.js.cn/blog/10-years/)（V8 10 周年历史概述）
...
- `可选` [C语言 目标文件和可执行文件（ELF文件）](https://www.jianshu.com/p/7c609b70acbd)
- `可选` [JIT Compilation：理解与实现](https://juejin.cn/post/6963984721453776933 "https://juejin.cn/post/6963984721453776933")
- `可选` [AOT,JIT区别，各自优劣，混合编译](https://blog.csdn.net/h1130189083/article/details/78302502)
...
- `可选` [开篇词 | 如何学习谷歌高性能 JavaScript 引擎V8？](https://time.geekbang.org/column/article/211673)
- `可选` [走进chrome内心，了解V8引擎是如何工作的](https://segmentfault.com/a/1190000040331440)
- `可选` [V8有了全新的超快速非优化JS编译器，性能提高5-15％](https://mp.weixin.qq.com/s/wMWiSpXmsoGilCjKDgng1Q)
...
- `可选` [TurboProp Mid-Tier Compiler](https://docs.google.com/document/d/1NeOsqjPPAcDWbuHxW5MobzVQgj9qZd6NqKUnz0h-fOw/edit#)
- `可选` [Ignition Design Doc](https://docs.google.com/document/d/11T2CRex9hXxoJwbYqVQ32yIPMh0uouUZLdyrtmMoL44/edit#)
- `可选` [03 | 快属性和慢属性：V8是怎样提升对象属性访问速度的？](https://time.geekbang.org/column/article/213250)
- `可选` [JavaScript 引擎基础：Shapes 和 Inline Caches](https://zhuanlan.zhihu.com/p/38202123)
- `可选` [V8中的快属性与内联缓存](https://juejin.cn/post/7023253397390229534 "https://juejin.cn/post/7023253397390229534")
- `可选` [V8 中的快慢属性与快慢数组 | Roger Leung‘s Epcot](https://z3rog.tech/blog/2020/fast-properties.html#%E5%8A%A8%E6%80%81%E6%89%A9%E5%AE%B9%E4%B8%8E%E6%94%B6%E7%BC%A9)
- `可选` [奇技淫巧学 V8 之一，对象访问模式优化](https://zhuanlan.zhihu.com/p/28777722)
- `可选` [V8中Speculative Optimization简介](https://www.sec4.fun/2020/06/19/v8TurboFan/)
- `可选` [\[译\] V8引擎中基于推测的优化介绍](https://zhuanlan.zhihu.com/p/51047561)
- `可选` [JavaScript到底是解释型语言还是编译型语言?](https://segmentfault.com/a/1190000013126460)
- `可选` [JavaScript 是如何运行的？](https://juejin.cn/post/6844903954812239880 "https://juejin.cn/post/6844903954812239880")
- `可选` [JavaScript：V8编译过程](https://juejin.cn/post/6844903953981767688 "https://juejin.cn/post/6844903953981767688")
- `可选` [认识 V8 引擎](https://zhuanlan.zhihu.com/p/27628685)
- `可选` [JAVASCRIPT AST VISUALIZER](https://resources.jointjs.com/demos/javascript-ast)
- `可选` [JavaScript代码是如何被执行的](https://segmentfault.com/a/1190000023133326)

## 计算机

- `可选` [寄存器和栈的关系](https://blog.csdn.net/qq_33574890/article/details/97932620)
- `可选` [CPU架构中的栈和寄存器？](https://www.zhihu.com/question/27683261)
- `可选` [JVM架构 |栈式指令集与寄存器指令集有什么区别？](https://blog.csdn.net/weixin_43691058/article/details/107569880)
- `可选` [JVM的架构模型(区分栈的指令集架构和寄存器的指令架构)](https://www.jianshu.com/p/35f12c3ce2bf)
- `可选` [序列化理解起来很简单](https://zhuanlan.zhihu.com/p/40462507)
- `可选` [DSL 的误区](https://www.yinwang.org/blog-cn/2017/05/25/dsl)
- `可选` [谈谈 DSL 以及 DSL 的应用（以 CocoaPods 为例）](https://draveness.me/dsl/)
- `可选` [前端 DSL 实践指南（上）](https://zhuanlan.zhihu.com/p/107947462)
- `可选` [什么是图灵完备？](https://www.zhihu.com/question/20115374)
- `可选` [怎样设计一套程序设计语言？](https://www.zhihu.com/question/19756886)
- `可选` [中间表示(Intermediate Representation)](https://blog.csdn.net/SHU15121856/article/details/104711426)
- `可选` [编译原理](https://segmentfault.com/a/1190000016430222)
- `可选` [编译原理入门篇|一篇文章理解编译全过程](https://www.cnblogs.com/fisherss/p/13905395.html)
- `可选` [\[编译原理\]概览](http%3A%2F%2Fwww.nicogatekeeper.com%2Findex.php%2Farchives%2F8%2F "http://www.nicogatekeeper.com/index.php/archives/8/")
- `可选` [开发者应知道的编译原理和语言基础知识](https://www.jianshu.com/p/0913993a4c3f)
- `可选` [漫话CPU指令集架构](https://zhuanlan.zhihu.com/p/46170108)
- `可选` [处理器架构、指令集和汇编语言，三者有何关系？](https://www.zhihu.com/question/23474438)
- `可选` [CPU的内部架构和工作原理](https://blog.csdn.net/stpeace/article/details/80101441)
- `可选` [CPU处理器架构和工作原理浅析](http%3A%2F%2Fc.biancheng.net%2Fview%2F3456.html "http://c.biancheng.net/view/3456.html")
- `可选` [DRAM、SDRAM和SRAM的区别](http%3A%2F%2Fwww.chinastor.com%2Fbaike%2Fstorage%2F020I62302017.html "http://www.chinastor.com/baike/storage/020I62302017.html")
- `可选` [CPU 是怎样工作的？](https://zhuanlan.zhihu.com/p/72043703)
- `可选` [彻底搞懂 CPU 中的内存结构](https://zhuanlan.zhihu.com/p/55429568)
- `可选` [计算机缓存Cache以及Cache Line详解](https://zhuanlan.zhihu.com/p/37749443)
- `可选` [浅析CPU高速缓存(cache)](https://zhuanlan.zhihu.com/p/340573903)
- `可选` [指令周期、机器周期和时钟周期](https://zhuanlan.zhihu.com/p/97987044)
- `可选` [计算机组成原理：时钟周期、机器周期和指令周期](https://blog.csdn.net/billbonaparte1/article/details/51297189)
- `可选` [ROM, FLASH和RAM的区别](https://zhuanlan.zhihu.com/p/38339306)
- `可选` [什么是虚拟机 Virtual Machine ?](https://zhuanlan.zhihu.com/p/53692225)
- `可选` [浅谈STM32的启动过程](https://zhuanlan.zhihu.com/p/337203514)
- `可选` [ARM 之七 主流编译器（armcc、iar、gcc for arm）详细介绍](https://blog.csdn.net/ZCShouCSDN/article/details/89553323)
- `可选` [交叉编译](https://blog.csdn.net/whatday/article/details/73930604)
- `可选` [Introduction to cross-compiling for Linux](http%3A%2F%2Flandley.net%2Fwriting%2Fdocs%2Fcross-compiling.html "http://landley.net/writing/docs/cross-compiling.html")
